...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-09-2023 a las 04:49:18
...
(1, 'INV-0001', '2022-02-28', 'Lucho Florez', '', 2147483647, '', 100, 10, 108, 49, 0, 49, 49, 2, 1, 0, 2),
(2, 'INV-0002', '2022-03-24', 'Bernardo Galán', '', 2147483647, '', 300, 354, 354, 354, 18, 354, 354, 1, 1, 1, 2),
(3, 'INV-0003', '2022-04-15', 'Fredy Patricio', '', 2147483647, '', 860, 1015, 10, 1005, 155, 500, 505, 2, 2, 1, 2),
...
CREATE TABLE `order_item` (
  ...
  `order_item_status` tinyint(8) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `order_item` (`id`, `productName`, `quantity`, `rate`, `total`, `lastid`, `added_date`, `order_item_status`) VALUES
(5, 2, '1', '100', '100.00', 1, '0000-00-00', 0),
(7, 1, '2', '30', '60.00', 3, '2022-04-15', 0),
(8, 2, '4', '150', '600.00', 3, '2022-04-15', 0),
(9, 3, '1', '200', '200.00', 3, '2022-04-15', 0),
(10, 1, '2', '30', '60.00', 4, '2022-04-15', 0),
(13, 2, '2', '150', '300.00', 2, '2022-04-15', 0),
(14, 3, '1', '200', '200.00', 5, '2022-05-01', 0),
(15, 5, '1', '250', '250.00', 6, '2022-05-01', 0),
(16, 5, '1', '250', '250.00', 7, '2022-05-03', 0);
