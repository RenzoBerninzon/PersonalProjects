            ...
            <div class="navbar-collapse">
                ...
                <ul class="navbar-nav my-lg-0 ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted  " href="./constant/logout.php" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                cerrar sesion
                            <!-- <img src="./assets/uploadImage/Profile/usuario-admin.png" alt="user" class="profile-pic" /> -->
                        </a>
